...
export default function handler(req, res) {
    ...
    const Products = [
        {
          "id": 23,
          "title": "Encendedor - Clipper de Aluminio Nor. 1 Backpack, Fits 15 Picador",
          "price": 109.95,
        ...
        {
          "id": 22,
          "title": "Picador - Picador de Plastico Nor. 1 Backpack, Fits 15 Picador",
          "price": 160.95,
        ...
        {
          "id": 21,
          "title": "Picador - Picador de Aluminio Nor. 1 Backpack, Fits 15 Picador",
          "price": 1950.95,
          "description": "Your perfect pack Picador for everyday use and walks in the forest. Stash your Picador (up to 15 inches) in the padded sleeve, your everyday",
          "category": "Picadores",
      ...
      const finById = (category)=> {
       
          const resultado = Products.filter( product => product.category ===   category );
